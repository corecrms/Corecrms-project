                    ...
                    <table class="table" id="example">
                        ...
                        <tbody>
                            ...
                            @forelse ($activities as $activity)
                                <tr>
                                    <td class="align-middle">{{ $activity->updated_at->format('d-m-Y') ?? '' }}</td>
                                    <td class="pt-3">{{ $activity->action ?? '' }}</td>
                                    <td class="pt-3">${{ $activity->credit_balance ?? '' }}</td>
                                    <td class="pt-3">${{ $activity->added_deducted ?? '...' }}</td>
                                    <td class="pt-3">{{ $activity->comment ?? '...' }}</td>
                                </tr>
                            @empty
                                <tr>
