    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Edit Deposit Category</h3>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="date" class="form-control subheading" id="date" name="date" value="{{ $deposit->date }}" required>
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <select class="form-control form-select subheading" name="account_id" id="account_id" required>
                                          ...
                                          @forelse ($accounts as $account)
                                              <option value="{{ $account->id }}" {{ $account->id == $deposit->account_id ? 'selected' : '' }}>{{ $account->name }}</option>
                                            @empty
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control form-select subheading" name="deposit_category_id" id="deposit_category_id" required>
                                          ...
                                          @forelse  ($depositCategories as $depositCategory)
                                              <option value="{{ $depositCategory->id }}" {{ $depositCategory->id == $deposit->deposit_category_id ? 'selected' : '' }}>{{ $depositCategory->name }}</option>
                                            @empty
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Amount" class="form-control subheading" id="amount" name="amount" value="{{ $deposit->amount }}" required>
                                      </div>
                                    </div>
                                </div>
