    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Deposit</h3>
            </div>
                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                            @can('deposit-create')
                                <a href="{{ route('deposits.create') }}" class="btn create-btn rounded-3 mt-2">
                    ...
                    <table class="table product-table datanew dataTable no-footer" id="example" role="grid"
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @canany(['deposit-edit','deposit-delete'])
                                    ...
                                    <td class="align-middle">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{$deposit->id}}"/>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        @can('deposit-delete')
                                            <form class="d-inline delete-deposit-category-form" method="post"
                                                action="{{ route('deposits.destroy', $deposit->id) }}">
                                                @csrf
                                                @method('DELETE')

                                                <button type="submit" class="btn text-danger btn-outline-light"
                                                    onclick="return confirm('Are you sure to delete this deposit?')">
