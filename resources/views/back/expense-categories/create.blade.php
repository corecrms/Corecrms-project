    ...
    <div class="content">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mt-5 fs-2">Product Add Expense Category </h1>
                    <p>Add a product Expense Category
                    </p>
                </div>
            </div>
            <div class="create-product-form rounded">
                ...
                <form action="{{ route('expense-categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Expense Category Name</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Expense Category Logo</label>
                    ...
                    <a href="{{ route('expense-categories.index') }}" class="btn cancel-btn">Back</a>
                </form>
            </div>
        </div>
    </div>
