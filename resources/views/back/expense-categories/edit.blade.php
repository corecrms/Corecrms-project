    ...
    <div class="content">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mt-5 fs-2">Product Edit Expense Category </h1>
                    <p>Edit a product Expense Category
                    </p>
                </div>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="brand_name">Expense Category Name</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="brand_img">Expense Category Logo</label>
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Edit Expense Categorys</h3>
            </div>
