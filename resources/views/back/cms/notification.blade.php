    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Notification</h3>
            </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($notifications as $notification)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        {{-- <a class=" text-decoration-none btn edit-category-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModalToggle{{ $notification->id }}">
                                            <img src="{{ asset('back/assets/dasheets/img/edit-2.svg') }}" class="p-0 me-2 ms-0" alt="" />
                                        </a> --}}
                                        <form class="d-inline delete-brand-form" method="post"
                                            ...
                                            @method('DELETE')
                                            <button type="submit" class="btn text-danger btn-outline-light"
                                                onclick="return confirm('Are you sure to delete notification?')">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('notification.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn save-btn me-2 text-white">Send</button>
                        </form>
                    </div>
                </div>
            </div>
