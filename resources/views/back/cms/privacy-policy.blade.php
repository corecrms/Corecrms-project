...
<div class="content">
    <div class="container-fluid px-4 mt-3">
        <div class="border-bottom">
            <h3 class="all-adjustment text-center pb-2 mb-0">Privacy Policy</h3>
        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="privacy_policy" class="mb-1">Privacy Policy<span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control subheading" id="privacy_policy" name="privacy_policy">{{$setting->privacy_policy ?? ''}}</textarea>
                            </div>
                        </div>
