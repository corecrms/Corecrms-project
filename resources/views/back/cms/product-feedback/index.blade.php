    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">All Reviews</h3>
            </div>
                    ...
                    <table class="table product-table datanew dataTable no-footer" id="example" role="grid"
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Customer Review</th>
                                ...
                                <tr >
                                    ...
                                    <td class="align-middle">
                                        {{-- <a class=" text-decoration-none btn edit-category-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModalToggle{{ $review->id }}">
                                        ...
                                        <form class="d-inline delete-brand-form" method="post"
                                            action="{{ route('product-reviews.destroy', $review->id) }}">
                                            @csrf
                                            @method('DELETE')
