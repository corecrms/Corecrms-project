    ...
    <div class="content">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mt-5 fs-2">Edit Purchase Invoice </h1>
                </div>
            </div>
            <div class="create-product-form rounded" style="padding: 20px 20px 80px 20px">
                                            ...
                                            @if ($vendors->count() > 0)
                                                @foreach ($vendors as $vendor)
                                                    <option value="{{ $vendor->id }}"
                                                        {{ $vendor->id == $purchaseInvoice->vendor_id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="order_date" class="form-control"
                                            value="{{ $purchaseInvoice->order_date }}" id="orderDate">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="delivery_date" class="form-control"
                                            value="{{ $purchaseInvoice->delivery_date }}" id="deliveryDate">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="invoice_number" class="form-control"
                                            value="{{ $purchaseInvoice->invoice_number }}" readonly id="invoiceNumber">
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reference_number" class="form-control"
                                        value="{{ $purchaseInvoice->reference_number }}" id="referenceNumber">
                                </div>
                            </div> --}}
                            </div>
                        </div>
                                                ...
                                                <tr data-select2-id="27">
                                                    ...
                                                    <td>
                                                        <div class="form-group input-group price-input">
                                                            <input class="form-control price" required="required" readonly
                                                                placeholder="Price"
                                                    ...
                                                    <div class="form-group input-group price-input">
                                                        <input class="form-control discount" placeholder="Discount"
                                                            name="items[{{ $key }}][discount]" type="number"
                                                            value="{{ $item->discount }}">
                                                        <span class="input-group-text">USD</span>
                                                    </div>
                                                </td> --}}
                ...
                <div class="form-group mb-4">
                    ...
                    <div class=" float-end">
                        ...
                        <a href="{{ route('purchase-invoices.index') }}" class="btn cancel-btn">Back</a>
                    </div>
                </form>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('change', '.item', function() {
                ...
                // Get the purchase price from the data-price attribute
                var purchasePrice = selectedOption.data('price');

                // Find the .price input in the same row and set its value to the purchase price
                $(this).closest('tr').find('.price').val(purchasePrice);
            });
        });
