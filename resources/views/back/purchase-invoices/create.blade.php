    ...
    <div class="content">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mt-5 fs-2">Add Purchase Invoice </h1>
                </div>
            </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="delivery_date" class="form-control"
                                            value="{{ date('Y-m-d') }}" id="delivery_date">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="invoice_no" class="form-control"
                                            value="{{ getInvoiceNo('#PUR') }}" readonly id="invoiceNumber">
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table"
                                        ...
                                        <tbody class="ui-sortable" data-repeater-item="" data-select2-id="28">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="form-group">
                                                        <textarea class="form-control" rows="2" placeholder="Description" name="items[0][description]" cols="50"></textarea>
                                                    </div>
                                                </td>
                                                <td colspan="5"></td>
                                            </tr>
