    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Product Sale Report</h3>
            </div>
                    ...
                    <table class="table" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="text-secondary">Qty Sold</th>
                                ...
                                @foreach ($sale->productItems as $item)
                                    <tr>
                                        <td class="text-secondary">
                                            <label for="checkbox{{$sale->id}}" class="checkbox">
                                                <input class="checkbox__input" type="checkbox" id="checkbox{{$sale->id}}" />
                                                <svg class="checkbox__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
                                                    <rect width="21" height="21" x=".5" y=".5" fill="#FFF"
                                                        stroke="rgba(76, 73, 227, 1)" rx="3" />
                                                    <path class="tick" stroke="rgba(76, 73, 227, 1)" fill="none"
                                        ...
                                        <td class="text-secondary align-middle">
                                            {{ $item->product->ailse ?? '' }}-{{ $item->product->rack ?? '' }}-{{ $item->product->shelf ?? '' }}-{{ $item->product->bin ?? '' }}
                                        </td>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            //on click .applyBtn ajax call for filter data of sales between date range
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                var start = picker.startDate.format('YYYY-MM-DD');
                var end = picker.endDate.format('YYYY-MM-DD');
                let baseUrl = "{{ route('sale.product.filter') }}";
