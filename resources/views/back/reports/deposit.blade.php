    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Deposit Report</h3>
            </div>
                    ...
                    <div class="row my-3">
                        <div class="col-md-3 col-12 mt-2">
                            <div class="input-search position-relative">
                                <input type="text" placeholder="Search Deposit" class="form-control rounded-3 subheading"
                                    id="custom-filter" />
                        ...
                        <div class="col-md-9 col-12 text-end">
                            ...
                            <a href="{{ route('deposits.create') }}" class="btn create-btn rounded-3 mt-2">Create <i
                    ...
                    <table class="table" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="text-secondary">Deposit Date</th>
                                <th class="text-secondary">Deposit Category</th>
                                <th class="text-secondary">Total Deposits</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @foreach ($deposits as $deposit)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $deposit->created_at->format('d-m-y') }}</td>
                                    <td class="align-middle">{{ $deposit->name }}</td>
                                    <td class="align-middle">${{ $deposit->total_amount }}</td>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            //on click .applyBtn ajax call for filter data of deposits between date range
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                var start = picker.startDate.format('YYYY-MM-DD');
                var end = picker.endDate.format('YYYY-MM-DD');
                let baseUrl = "{{ route('deposit.filter') }}";
