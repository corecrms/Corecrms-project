    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Product Purchase Report</h3>
            </div>
                    ...
                    <div class="row my-3">
                        <div class="col-md-3 col-12 mt-2">
                            <div class="input-search position-relative">
                                <input type="text" placeholder="Search Purchase" class="form-control rounded-3 subheading"
                                    id="custom-filter" />
                    ...
                    <table class="table" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="text-secondary">Qty purchased</th>
                                ...
                                @foreach ($purchase->purchaseItems as $item)
                                    <tr>
                                        <td class="text-secondary">
                                            <label for="checkbox{{$purchase->id}}" class="checkbox">
                                                <input class="checkbox__input select-checkbox" type="checkbox" id="checkbox{{$purchase->id}}" />
                                                <svg class="checkbox__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
                                                    <rect width="21" height="21" x=".5" y=".5" fill="#FFF"
                                                        stroke="rgba(76, 73, 227, 1)" rx="3" />
                                                    <path class="tick" stroke="rgba(76, 73, 227, 1)" fill="none"
                                        ...
                                        {{-- <td class="text-primary align-middle">{{ $purchase->reference }}</td> --}}
                                        ...
                                        <td class="align-middle">{{ $purchase->vendor->user->name ?? 'N/A' }}</td>
                                        <td class="align-middle">{{ $purchase->warehouse->users->name ?? 'N/A' }}</td>

                                        <td class="text-secondary align-middle">{{ $item->product->name }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                ...
                let baseUrl = "{{ route('purchase.product.filter') }}";
