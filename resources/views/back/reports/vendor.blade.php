    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Vendor Report</h3>
            </div>
                ...
                <div class="card-header border-0 bg-white">
                    <div class="row my-3">
                        ...
                        <div class="col-md-9 col-12 text-end">
                            ...
                            <a href="{{ route('vendors.create') }}" class="btn create-btn rounded-3 mt-2">Create <i
                    ...
                    <table class="table" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="text-secondary">Total Purchase</th>
                        ...
                        <tbody>
                            @foreach ($vendors as $vendor)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $vendor['total_sales'] }}</td>
                                    <td class="align-middle">${{ $vendor['total_amount'] }}</td>
                                    <td class="align-middle">${{ $vendor['total_paid'] }}</td>
                                    <td class="align-middle">${{ $vendor['total_due'] }}</td>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            //on click .applyBtn ajax call for filter data of vendors between date range
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                var start = picker.startDate.format('YYYY-MM-DD');
                var end = picker.endDate.format('YYYY-MM-DD');
                let baseUrl = "{{ route('vendor.filter') }}";
