    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Purchase Report</h3>
            </div>
                            ...
                            @foreach ($purchases as $purchase)
                                ...
                                <tr>
                                    <td class="text-secondary">
                                        <label for="myCheckbox09" class="checkbox">
                                            <input class="checkbox__input select-checkbox" type="checkbox" id="myCheckbox09" />
                                    ...
                                    <td class="align-middle">{{ $purchase->warehouse->users->name ?? '' }}</td>
                                    ...
                                    <td class="align-middle">${{ $purchase->amount_due ?? '0.00' }}</td>
                                    <td class="align-middle">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                ...
                let baseUrl = "{{ route('purchase.filter') }}";
                ...
                columns: [
                    ...
                    { data: 'warehouse', name: 'warehouse' },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<span class="badges green-border text-center">${data}</span>`;
                        }
                    },
                    { data: 'grand_total', name: 'grand_total' },
                    { data: 'amount_recieved', name: 'amount_recieved' },
