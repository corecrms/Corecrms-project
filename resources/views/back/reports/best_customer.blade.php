...
@section('title', 'Best customerss List')
@section('style')
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Best customers Report</h3>
            </div>
            ...
            <div class="card border-0 card-shadow rounded-3 p-2 mt-5">
                    ...
                    <div class="row my-3">
                        <div class="col-md-3 col-12 mt-2">
                            <div class="input-search position-relative">
                                <input type="text" placeholder="Search Best customers"
                ...
                <div class="table-responsive">
                    <table class="table" id="example">
                        ...
                        <tbody>
                            @foreach ($best_customers as $customers)
                                <tr>
                                    <td class="align-middle">{{ $customers['customer'] }}</td>
                                    <td class="text-primary align-middle">{{ $customers['phone'] }}</td>
                                    <td class="align-middle">{{ $customers['email'] ?? '' }}</td>
                                    <!-- This is now in the parent unit -->

                                    <td class="align-middle">{{ $customers['total_sales'] }} </td>
                                    <!-- This is now in the parent unit -->
                                    <td class="align-middle">{{ $customers['total_amount'] }}</td>
