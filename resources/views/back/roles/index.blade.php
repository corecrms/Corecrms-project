        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            ...
            <div class="card card-shadow border-0 mt-3 rounded-3 p-2">
                ...
                <div class="table-responsive">
                    <table class="table" id="example" style="overflow-x:auto;">
                        <thead class="fw-bold">
                            <tr>
                        ...
                        <tbody>
                            ...
                            @foreach ($roles as $key => $role)
                                <tr>
                                    ...
                                    <td class="align-middle" style="width: 800px">
                                        @if (!empty($role->permissions))
                                            @foreach ($role->permissions as $v)
                                                <label class="badge rounded-pill text-bg-secondary">{{ $v->name }}</label>
                                            @endforeach
                                        @endif
                                    </td>
