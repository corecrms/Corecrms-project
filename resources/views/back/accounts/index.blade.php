    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Account</h3>
            </div>
                    ...
                    <table class="table product-table datanew dataTable no-footer" id="example" role="grid"
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Initial Balance</th>
                                @canany(['account-edit','account-delete'])
                                    ...
                                    <td class="align-middle">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{$account->id}}"/>
                                    ...
                                    <td class="align-middle">
                                        @can('account-edit')
                                            <a class=" text-decoration-none btn edit-category-btn" data-bs-toggle="modal"
                                                data-bs-target="#editModalToggle{{ $account->id }}">
                            ...
                            <div class="row mb-3">
                                {{-- <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="acc_no">Select Customer</label>
        ...
        @foreach ($accounts as $account)
            <!-- Edit Modal STart -->
            <div class="modal fade" id="editModalToggle{{ $account->id }}" aria-hidden="true"
                                ...
                                <div class="row mb-3">
                                    {{-- <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="customer_id" id="customer_id" class="form-control" required>
                                                @foreach ($customers as $customer)
                                                    <option value="{{$customer->id}}" {{$customer->id == ($account->customer->id ?? '') ? 'selected':''}} >{{$customer->user->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div> --}}
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="acc_no">Account Number</label>
                                            <input type="text" class="form-control" name="acc_no" id="acc_no"
                                                placeholder="" required value="{{ $account->acc_no }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="name">Account Name</label>
                                            <input type="text" class="form-control" name="name" id="name"
                                                placeholder="" required value="{{ $account->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="init_balance">Initial Balance</label>
                                            <input type="number" class="form-control" name="init_balance"
                                                id="init_balance" placeholder="" required
                                                value="{{ $account->init_balance }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="details">Details</label>
                                    <textarea class="form-control" id="details" name="details" rows="3">{{ $account->details }}</textarea>
                                </div>
