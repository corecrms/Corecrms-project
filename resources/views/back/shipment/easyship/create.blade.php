                ...
                <form id="shipmentForm" action="{{route('shipment.store')}}" method="POST">
                    ...
                    <div class="row mt-2">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="originLine1" name="origin_address[line_1]"
                                required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originLine2">Address Line 2</label>
                            <input type="text" class="form-control" id="originLine2" name="origin_address[line_2]">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originState">State</label>
                            <input type="text" class="form-control" id="originState" name="origin_address[state]">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originCity">City</label>
                            <input type="text" class="form-control" id="originCity" name="origin_address[city]" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originPostalCode">Postal Code</label>
                            <input type="text" class="form-control" id="originPostalCode"
                                name="origin_address[postal_code]" required>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="form-group col-md-6">
                            <label for="originLine2">Address Line 2</label>
                            <input type="text" class="form-control" id="originLine2" name="destination_address[line_2]">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originState">State</label>
                            <input type="text" class="form-control" id="originState" name="destination_address[state]">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originCity">City</label>
                            <input type="text" class="form-control" id="originCity" name="destination_address[city]"
                                required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originPostalCode">Postal Code</label>
                            <input type="text" class="form-control" id="originPostalCode"
                                name="destination_address[postal_code]" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originCountry">Country Code</label>
                            {{-- <input type="text" class="form-control" id="originCountry"
                        ...
                        <div class="form-group col-md-6">
                            <label for="originContactName">Contact Name</label>
                            <input type="text" class="form-control" id="originContactName"
                                name="destination_address[contact_name]" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originCompanyName">Company Name</label>
                            <input type="text" class="form-control" id="originCompanyName"
                                name="destination_address[company_name]">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originContactPhone">Contact Phone</label>
                            <input type="text" class="form-control" id="originContactPhone"
                                name="destination_address[contact_phone]" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="originContactEmail">Contact Email</label>
                            <input type="email" class="form-control" id="originContactEmail"
                                name="destination_address[contact_email]" required>
                        </div>
                    </div>
                    ...
                    <div id="parcels">
                        <div class="parcel mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="itemHsCode">Category</label>
                                    <input type="text" class="form-control" id="itemHsCode"
                                        name="parcels[0][items][0][item_category_id]" required>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="itemContainsBatteryPi967"
                                        name="parcels[0][items][0][contains_battery_pi967]" required>
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="itemContainsLiquids"
                                        name="parcels[0][items][0][contains_liquids]" required>
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                </div> --}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="itemOriginCountry"
                                        name="parcels[0][items][0][declared_customs_value]" required>
                                </div>
               ...
               <h5>Parcel ${parcelIndex}</h5>
                    <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="itemHsCode">Category</label>
                                    <input type="text" class="form-control" id="itemHsCode"
                                        name="parcels[${parcelIndex - 1}][items][0][item_category_id]" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="itemHsCode">Hs Code</label>
                                    <input type="text" class="form-control" id="itemHsCode"
