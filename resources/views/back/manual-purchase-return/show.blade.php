                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 col-6 mt-2">
                            ...
                            <p class="m-0">{{ $purchase_return->vendor->user->name ?? '' }}</p>
                            <p class="m-0">{{ $purchase_return->vendor->user->email ?? '' }}</p>
                            <p class="m-0">{{ $purchase_return->vendor->user->contact_no ?? '' }}</p>
                            <p class="m-0">{{ $purchase_return->vendor->user->address ?? '' }}</p>
                        </div>
                        <div class="col-md-4 col-6 mt-2">
                        ...
                        <div class="col-md-4 col-6 mt-2">
                            ...
                            <p class="m-0">Reference : {{ $purchase_return->reference ?? '' }}</p>
                            <p class="m-0">Payment Status : <span
                                    class="badges green-border text-center">{{ $purchase_return->payment_status ?? '' }}</span></p>
                            <p class="m-0">Warehouse : {{ $purchase_return->warehouse->users->name ?? '' }}</p>
                            <p class="m-0">Status : <span
                                    class="badges blue-border text-center">{{ $purchase_return->status ?? '' }}</span></p>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2 px-3 ">
                        ...
                        <div class="col-md-4 border rounded-2 py-2">
                            <div class="row border-bottom subheading">
                                ...
                                <div class="col-md-6 col-6">$ {{ $purchase_return->order_tax ?? '0' }} %</div>
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Discount</div>
                                <div class="col-md-6 col-6">$ {{ $purchase_return->discount ?? '0.00' }}</div>
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Shipping</div>
                                <div class="col-md-6 col-6">$ {{ $purchase_return->shipping ?? '0.00' }}</div>
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Grand Total</div>
                                <div class="col-md-6 col-6">$ {{ $purchase_return->grand_total ?? '0.00' }}</div>
                            </div>
                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Paid</div>
                                <div class="col-md-6 col-6">$ {{ $purchase_return->amount_paid ?? '0.00' }}</div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-6">Due</div>
                                <div class="col-md-6 col-6">$ {{ $purchase_return->amount_due ?? '0.00' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
