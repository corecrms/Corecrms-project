        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex gap-4 flex-wrap align-items-baseline my-2 right-btn">
                    ...
                    <a href="{{ route('sales-invoices.create') }}" type="button" class="btn my-btn"><span><i
                    ...
                    <div class="table-responsive">
                        <table class="table product-table datanew dataTable no-footer" id="example" role="grid"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        ...
                                        style="width: 94.3438px;">Customer</th>
                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">No sales invoice Found</td>
                                    </tr>
                                @endforelse
