    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">All Cards</h3>
            </div>
                    ...
                    <div class="row my-3">
                        <div class="col-md-4 col-12">
                            <div class="input-search position-relative">
                                <input type="text" placeholder="Search Account" class="form-control rounded-3 subheading"
                                    id="custom-filter" />
                    ...
                    <table class="table product-table datanew dataTable no-footer" id="example" role="grid"
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Card No. (Last 4)</th>
                                <th class="align-middle">Card Expiry Month</th>
                                <th class="align-middle">Card Expiry Year</th>
                                ...
                                <tr class="even">
                                    <td class="align-middle">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{ $card->id }}" />
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a class=" text-decoration-none btn edit-category-btn" data-bs-toggle="modal"
                                            data-bs-target="#editModalToggle{{ $card->id }}">
                                        ...
                                        <form class="d-inline delete-brand-form" method="post"
                                            action="{{ route('credit-cards.destroy', $card->id) }}">
                                            @csrf
                                            @method('DELETE')
        ...
        @foreach ($cards as $card)
            <!-- Edit Modal STart -->
            <div class="modal fade" id="editModalToggle{{ $card->id }}" aria-hidden="true"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('credit-cards.update', $card->id) }}" method="POST"
                                ...
                                <div class="row mt-2">
                                    <div class=" mt-2">
                                        <div class="form-group">
                                            <label for="card_brand" class="mb-1 fw-bold">Card Name</label>
                                            <input type="text" class="form-control subheading" id="card_brand"
                                                name="card_brand" placeholder="e.g Visa" value="{{$card->card_brand ?? ''}}" />
                                        </div>
                                    </div>
                                    <div class=" mt-2">
                                        <div class="form-group">
                                            <label for="card_last_four" class="mb-1">Card last four digit</label>
                                            <input type="text" name="card_last_four" id="card_last_four"
                                                class="form-control subheading" placeholder="e.g 1234" value="{{$card->card_last_four ?? ''}}">
                                        </div>
                                    </div>
                                    <div class=" mt-2">
                                        <div class="form-group">
                                            <label for="card_exp_month" class="mb-1 fw-bold">Expiry Month</label>
                                            <input type="text" class="form-control subheading" id="card_exp_month"
                                                name="card_exp_month" placeholder="e.g 11" value="{{$card->card_exp_month}}"/>
                                        </div>
                                    </div>
                                    <div class=" mt-2">
                                        <div class="form-group">
                                            <label for="card_exp_year" class="mb-1 fw-bold">Expiry Year</label>
                                            <input type="text" class="form-control subheading" id="card_exp_month"
                                                name="card_exp_year" placeholder="e.g 2025" value="{{$card->card_exp_year}}"/>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".delete-category-form").submit(function() {
                var decision = confirm("Are you sure, You want to Delete this Card?");
                if (decision) {
                    return true;
                }
                return false;
