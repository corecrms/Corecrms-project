    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Leave Type</h3>
            </div>
                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                            <a class="btn create-btn rounded-3 mt-2" href="{{route('leave-request.index')}}">
                                Back
                            </a>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <a class=" text-decoration-none btn edit-category-btn" data-bs-toggle="modal"
                                                data-bs-target="#editCategoryModel{{ $type->id }}">
                                            ...
                                            <form class="d-inline delete-category-form" method="post"
                                                action="{{ route('leave-type.destroy', $type->id) }}">
                                                @csrf
                                                @method('DELETE')
        ...
        @foreach ($leave_types as $type)
            <div class="modal fade" id="editCategoryModel{{ $type->id }}" aria-hidden="true"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('leave-type.update', $type->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="name">Title</label>
                                    <input type="text" class="form-control subheading" name="name" id="name"
                                        placeholder="Enter Title" required value="{{$type->name ?? ''}}">
                                </div>
