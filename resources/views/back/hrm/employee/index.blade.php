    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Employees</h3>
            </div>
                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                            <a class="btn create-btn rounded-3 mt-2" href="{{ route('employees.create') }}">
                    ...
                    <table id="example" class="table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Last Email</th>
                                <th class="align-middle">Phone</th>
                                <th class="align-middle">Company</th>
                                <th class="align-middle">Department</th>
                                <th class="align-middle">Designation</th>
                                <th class="align-middle">Office Shift</th>
                                    ...
                                    <td class="align-middle">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{ $employee->id }}" />
    ...
    <script>
            ...
            $('#deleteRowTrigger').on("click", function(event) { // triggering delete one by one
                if (confirm("Are you sure you won't be able to revert this!")) {
                    if ($('.deleteRow:checked').length > 0) { // at-least one checkbox checked
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('employees.multiple.delete') }}",
                            data: {
                                ids
                            },
        ...
        $(document).ready(function() {
            ...
            $(".delete-category-form").submit(function() {
                var decision = confirm("Are you sure, You want to Delete this employee?");
                if (decision) {
                    return true;
                }
                return false;
