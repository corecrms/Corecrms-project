    ...
    <div class="content">
                ...
                <div class="card-header border-0 bg-white">
                    <div class="row my-3">
                        ...
                        <div class="col-md-9 col-12 text-end">
                            ...
                            <a href="{{ route('manual-sale-return.create') }}" class="btn create-btn rounded-3 mt-2">Create
                        ...
                        <tbody>
                            @foreach ($returns as $return)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $return->customer->user->name ?? 'N/A'}}</td>
                                        ...
                                        <div>
                                            ...
                                            <div class="dropdown-menu p-2 ps-0" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item"
                                                    href="{{ route('manual-sale-return.show', $return->id) }}">
                                                    <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
                                                        class="img-fluid me-1" alt="" />
                                                    Detail Return
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ route('manual-sale-return.edit', $return->id) }}">
                                                    <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
                                                        class="img-fluid me-1" alt="" />
                                                    Edit Return
                                                </a>
                                                ...
                                                <form id="deleteForm"
                                                    action="{{ route('manual-sale-return.destroy', $return->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel"
            ...
            <div class="offcanvas-body">
                <form action="{{ route('manual_sale_return.filter') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div>
            ...
            $('#deleteRowTrigger').on("click", function(event) { // triggering delete one by one
                if (confirm("Are you sure you won't be able to revert this!")) {
                    if ($('.deleteRow:checked').length > 0) { // at-least one checkbox checked
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('manual_return.delete') }}",
                            data: {
                                ids
                            },
