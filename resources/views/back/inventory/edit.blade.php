    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Edit Bill</h3>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control subheading" type="date" id="billDate" value="{{$bill->bill_date ?? ''}}" />
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select subheading mt-1"
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}" {{$bill->vendor->id == $vendor->id ? 'selected': ''}}>{{ $vendor->user->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select subheading mt-1"
                                        ...
                                        @foreach ($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}" {{$bill->warehouse->id == $warehouse->id ? 'selected': ''}}>{{ $warehouse->users->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card card-shadow rounded-3 border-0 mt-4 p-3">
                    <div class="table-responsive">
                        <table class="table text-center" id="mainTable">
                            ...
                            <tbody>
                                @forelse ($bill->ProductItems as $productItem)
                                    <tr>
                                        <td class="align-middle">{{ $loop->iteration }}</td>
                                        <td class="product_name align-middle ">{{ $productItem->product->name }}</td>
                                        <td class=" align-middle ">{{ $productItem->product->sku }}</td>
                                        ...
                                        >
                                            ...
                                            value="{{ $productItem->quantity }}" min="0"
                                            />
                                        ...
                                        <td class="product_price align-middle">{{ $productItem->subtotal }}</td>
                                        <td class="align-middle" data-product='{{ json_encode($productItem->product) }}'>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7">No product items found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="row mt-2 px-3">
                        ...
                        <div class="col-md-4 border rounded-2">
                            <div class="row border-bottom subheading">
                                ...
                                <div class="col-md-6 col-6" id="order_tax_display">({{$bill->tax ?? '0'}}%)</div><span></span>
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Discount</div>
                                <div class="col-md-6 col-6" id="discount_display">${{$bill->discount?? '0.00'}}</div>
                            </div>
                            ...
                            <div class="row disabled-bg">
                                ...
                                <div class="col-md-6 col-6" id="grand_total">${{$bill->grand_total ?? '0.00'}}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-shadow rounded-3 border-0 mt-4 p-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1" class="mb-1 fw-bold">Due Date <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control subheading" type="date" id="dueDate" value="{{$bill->due_date ?? ''}}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="0%" class="form-control subheading"value="{{$bill->tax ?? '0'}}"
                                        id="order_tax" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="$0.00" class="form-control subheading"value="{{$bill->discount ?? '0'}}"
                                        id="discount" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <textarea class="form-control subheading" id="notes" placeholder="A few words" rows="5">{{$bill->details ?? ''}}</textarea>
                        </div>
                    </div>
                </div>
                <!-- Input Fields End -->
